...
- **Dashboard**, **Leave Management**, **Certificate Management**, **Attendance
  Management**, **Report Generation**, **Task Assignment**, **Analytics &
  Insights**, **Session Scheduler**, **AI Mentor**, **Assessment Management**,
  and **Notification & Reminder** are fully built (merged from parallel
  teammate branches). Every other module from the module sheet still has a
  sidebar entry and a "coming soon" placeholder in the same shell.
